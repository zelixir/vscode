...
// Code Slim: removed the chat view container + ChatViewPane registration (chat view/panel removed).
// The auxiliary bar's default panel pointed at this view, whose pane constructor chain requires
// IChatService -> IMcpService (unregistered), producing a startup error and an empty panel.
